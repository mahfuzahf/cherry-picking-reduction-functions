...
# == Job identity =============================================================
#SBATCH --job-name=rainbow-cpu-16
...
ls "$OPENSSL_PREFIX/include/openssl/evp.h"   && echo "evp.h        : found" \
                                              || echo "evp.h        : MISSING — compile will fail"
ls "$OPENSSL_PREFIX/lib/libcrypto.so"         && echo "libcrypto.so : found" \
                                              ...
                                              || echo "libcrypto.so : MISSING — runtime will fail"
echo "---------------------"
...
/gpfs01/home/psymf9/miniconda3/envs/rainbow_gen/bin/python /gpfs01/home/psymf9/choice-rf-rt/generation/n-16/cpu-generate/generate.py
