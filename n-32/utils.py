...
def optimise_kj(N, p, alpha, factor, lower_bound, t=-1, maxiter=5000000):   # add v_cost if want vanilla cost to be set beforehand
    ...
    # maximise the 
    # 5000000 normally
    res = minimize(lambda Kj: m_t(Kj, N, m_0), starting_values, bounds=bound, constraints=ineq_cons,method = "SLSQP", options={'disp': True, "maxiter": maxiter, "eps": 10000, "ftol": 1})
